...
RSpec.describe Spree::Admin::ReturnAuthorizationsController, type: :controller do
  ...
  describe '#load_return_items' do
    ...
    context '#edit' do
      subject do
        get :edit, params: { id: return_authorization.to_param, order_id: order.to_param }
      end
    ...
    context '#create failed' do
      subject do
        post :create, params: { return_authorization: { stock_location_id: nil }, order_id: order.to_param }
      end
    ...
    context '#update failed' do
      subject do
        put :update,  params: { return_authorization: { stock_location_id: nil }, id: return_authorization.to_param, order_id: order.to_param }
      end
