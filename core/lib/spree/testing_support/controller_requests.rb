...
module Spree
  module TestingSupport
    # A module providing convenience methods to test Open controllers in Rails controller/functional tests.
    # Possibly from inside an application with a mounted Open engine.
    #
    # *There is generaly no need* to use this module.
    # Instead, in a functional/controller test against a Spree controller, just use standard Rails functionality by including:
    #
    #   routes { Spree::Core::Engine.routes }
    #
    # And then use standard Rails test `get`, `post` etc methods.
    #
    # But some legacy code uses this ControllerRequests helper.
    # It must be included only in tests against Spree controllers, it will interfere
    ...
    #   end
    #
    # Use spree_get, spree_post, spree_put or spree_delete to make requests to the Spree engine,
    # and use regular get, post, put or delete to make requests to your application.
