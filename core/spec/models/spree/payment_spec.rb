...
RSpec.describe Spree::Payment, type: :model do
  ...
  context 'processing' do
    ...
    describe '#authorize!' do
      ...
      describe 'billing_address option' do
        ...
        context 'when the source is a credit card without an address' do
          ...
          it 'sends the order bill address' do
            expect(payment.payment_method).to(
              receive(:authorize).
                with(
                  amount_in_cents,
    ...
    describe '#cancel!' do
      ...
      context 'if void returns successful response' do
        ...
        it 'updates the state to void' do
      ...
      context 'if void returns failed response' do
        ...
        it 'raises gateway error and not change payment state or response_code', :aggregate_failures do
  ...
  context 'with source required' do
    context 'raises an error if no source is specified' do
      ...
      specify do
        expect { payment.process! }.to raise_error(Spree::Core::GatewayError, t('spree.payment_processing_failed'))
      end
    end
  end
  ...
  describe '#save' do
    ...
    context 'completed orders' do
      ...
      it 'updates payment_state and shipments' do
        ...
        Spree::Payment.create(amount: 100, order: order, payment_method: payment_method, source: card)
      end
    end
