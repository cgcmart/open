...
module Spree
  ...
  # Products properties include description, permalink, availability, shipping category, etc. that do not change by variant.
  class Product < Spree::Base
    ...
    has_many :possible_promotions, -> { advertised.active }, through: :promotion_rules, source: :promotion
    ...
    # If the master is invalid, the Product object will get its errors
    def validate_master
      unless master.valid?
