module Spree
  class ReturnItem < Spree::Base
    ...
    def exchange_shipments
      exchange_inventory_units.try(:shipment)
    end
    ...
    def should_restock?
      resellable? && variant.should_track_inventory? && customer_return && customer_return.stock_location.restock_inventory?
    end
  end
end
