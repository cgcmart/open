      ...
      module Storefront
        class ProductsController < ::Spree::Api::V2::BaseController
          ...
          def sorted_collection
            collection_sorter.new(collection, params, current_pricing_currency).call
          end

          def collection
            collection_finder.new(scope: scope, params: params, current_pricing_currency: current_pricing_currency).execute
          end
