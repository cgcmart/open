  ...
  module FrontendHelper
    ...
    def spree_breadcrumbs(taxon, separator = '')
      ...
      crumbs = [content_tag(:li,
        content_tag(:span, link_to(content_tag(:span, I18n.t('spree.home'), itemprop: 'name'), spree.root_path, itemprop: 'url') + separator, itemprop: 'item'), itemscope: 'itemscope', itemtype: 'https://schema.org/ListItem', itemprop: 'itemListElement',
