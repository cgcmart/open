...
module Spree
  module FrontendHelper
    ...
    def spree_breadcrumbs(taxon, separator = '&nbsp;')
      ...
      crumbs = [content_tag(:li, content_tag(:span, link_to(content_tag(:span, I18n.t('spree.home'), itemprop: 'name'), spree.root_path, itemprop: 'url') + separator, itemprop: 'item'), itemscope: 'itemscope', itemtype: 'https://schema.org/ListItem', itemprop: 'itemListElement')]
      if taxon
        crumbs << content_tag(:li, content_tag(:span, link_to(content_tag(:span, I18n.t('spree.products'), itemprop: 'name'), spree.products_path, itemprop: 'url') + separator, itemprop: 'item'), itemscope: 'itemscope', itemtype: 'https://schema.org/ListItem', itemprop: 'itemListElement')
